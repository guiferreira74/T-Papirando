...
<body>
    ...
    <div class="d-flex">
        ...
        <main id="main-container">
            <div id="corpo">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    // Verificar se o grau já está registrado
                ...
                <div class="text-center mb-3">
                    <button class="btn btn-primary" onclick="openAddModal()">Adicionar Novo Grau</button>
                </div>
        ...
        <!-- Modal de Adicionar/Editar Grau -->
        <div id="add-modal" class="modal">
            <div class="modal-content">
                <span class="close-btn" onclick="closeAddModal()">&times;</span>
                <form action="grau.php" method="POST">
                    <input type="hidden" id="cod_grau" name="cod_grau" value="<?php echo htmlspecialchars($cod_grau); ?>">
                    <div id="input">
                        <label for="tipo_grau_modal">Tipo de Grau:</label>
                        <input type="text" id="tipo_grau_modal" name="tipo_grau" value="<?php echo htmlspecialchars($tipo_grau); ?>" placeholder="Preencha o tipo de grau" required>
                    </div>
        ...
        <script>
            ...
            function openAddModal() {
                document.getElementById('tipo_grau_modal').value = getCookie('grau_tipo') || '';
                addModal.style.display = "block";
            }

            // Função para fechar o modal de adicionar
            function closeAddModal() {
                setCookie('grau_tipo', document.getElementById('tipo_grau_modal').value, 1);
            ...
            // Limpar formulário
            function clearForm() {
                document.getElementById("tipo_grau_modal").value = '';
            }
            ...
            function openEditModal(data) {
                document.getElementById('cod_grau').value = data.cod_grau;
                document.getElementById('tipo_grau_modal').value = data.tipo_grau;
                addModal.style.display = "block";
            }
