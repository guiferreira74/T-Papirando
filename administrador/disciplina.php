            ...
            <div class="table-container">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<a class='edit-button' href='disciplina.php?edit=" . $row['cod_disciplina'] . "'>Editar</a>";
                        echo "<a class='delete-button' href='#' onclick='openModal(\"disciplina.php?delete=" . $row['cod_disciplina'] . "\"); return false;'>Excluir</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
