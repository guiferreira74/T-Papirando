...
<body>
    <div>
        ...
        <form action="questao.php" method="post">
            ...
            <input type="text" name="resposta1" id="resposta1" required><br>
            
            <label for="resposta2">Resposta 2:</label>
            <input type="text" name="resposta2" id="resposta2" required><br>
            
            <label for="resposta3">Resposta 3:</label>
            <input type="text" name="resposta3" id="resposta3" required><br>
            
            <label for="resposta4">Resposta 4:</label>
            <input type="text" name="resposta4" id="resposta4" required><br>
            
            <label for="resposta_correta">Resposta Correta:</label>
            <input type="text" name="resposta_correta" id="resposta_correta" required><br>
